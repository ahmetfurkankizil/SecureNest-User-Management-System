...
var User = function () {
    ...
    var User = _classThis = /** @class */ (function (_super) {
        ...
        function User_1() {
            ...
            _this.username = (__runInitializers(_this, _id_extraInitializers), __runInitializers(_this, _username_initializers, void 0));
            _this.email = (__runInitializers(_this, _username_extraInitializers), __runInitializers(_this, _email_initializers, void 0));
            _this.verificationToken = (__runInitializers(_this, _email_extraInitializers), __runInitializers(_this, _verificationToken_initializers, void 0));
            _this.isVerified = (__runInitializers(_this, _verificationToken_extraInitializers), __runInitializers(_this, _isVerified_initializers, void 0));
    ...
    (function () {
        ...
        _verificationToken_decorators = [(0, typeorm_1.Column)()];
