...
var UserController = function () {
    ...
    var _checkVerification_decorators;
    var UserController = _classThis = /** @class */ (function () {
        ...
        UserController_1.prototype.register = function (userData) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userService.register(userData.username, userData.email)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        UserController_1.prototype.verifyEmail = function (username, verificationToken) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userService.verifyEmail(username, verificationToken)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        UserController_1.prototype.checkVerification = function (username) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userService.checkVerification(username)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    (function () {
        ...
        _verifyEmail_decorators = [(0, common_1.Get)('verify-email/:username/:verificationToken')];
        _checkVerification_decorators = [(0, common_1.Get)('check-verification/:username')];
        ...
        __esDecorate(_classThis, null, _checkVerification_decorators, { kind: "method", name: "checkVerification", static: false, private: false, access: { has: function (obj) { return "checkVerification" in obj; }, get: function (obj) { return obj.checkVerification; } }, metadata: _metadata }, null, _instanceExtraInitializers);
